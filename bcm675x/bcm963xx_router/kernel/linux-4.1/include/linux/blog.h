...
typedef void (*ovs_bcm_blog_mega_put_fast_stats_t)(void *net_p, const blog_fast_stats_t *stats);
extern ovs_bcm_blog_mega_put_fast_stats_t ovs_bcm_blog_mega_put_fast_stats_fn;
#endif
...
#if defined(CONFIG_BCM_OVS)
typedef unsigned long (*ovs_bcm_blog_mega_get_key_t)(void *mega);
extern ovs_bcm_blog_mega_get_key_t ovs_bcm_blog_mega_get_key_fn;

typedef void (*ovs_bcm_blog_mega_set_key_t)(void *mega, unsigned long blog_key);
extern ovs_bcm_blog_mega_set_key_t ovs_bcm_blog_mega_set_key_fn;
#endif
