...
#endif
#ifdef CONFIG_BP_PHYS_INTF
       BpGetOpticalModulePresenceExtIntrGpio(intf_type, intf_idx, mod_abs_gpio);
#else
       BpGetOpticalModulePresenceExtIntrGpio(mod_abs_gpio);
#endif
    }
    else
    {
...
#ifdef CONFIG_BP_PHYS_INTF
        BpGetSfpModDetectGpio(intf_type, intf_idx, mod_abs_gpio);
#else
        BpGetSfpDetectGpio(mod_abs_gpio);
#endif
    }
