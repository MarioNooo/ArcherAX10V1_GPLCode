...
function wl_key_update()
{
	...
	if (wep == "enabled") {
		if (document.forms[0].wl_akm_wpa.disabled == 0 && wpa == "enabled" ||
			...
			|| document.forms[0].wl_akm_wpa3.disabled == 0 && wpa3 == "enabled"
...
*/
		...
		if (wl_ure == "1") {
			...
			document.forms[0].wl_akm_wpa3.disabled = 0;
...
*/
	 ...
	 */
	wpa3 = document.forms[0].wl_akm_wpa3[document.forms[0].wl_akm_wpa3.selectedIndex].value;
	sae = document.forms[0].wl_akm_sae[document.forms[0].wl_akm_sae.selectedIndex].value;

	if (wpa3 == "enabled" || sae == "enabled")
		document.forms[0].wl_mfp.selectedIndex = <% nvram_get("wl_mfp"); %>
/*
#endif // endif
*/
...
-->
  ...
  <tr style="display:<% nvram_ternary("hapd_enable", "1", "table-row", "none"); %>;">
    ...
    <td>&nbsp;&nbsp;</td>
    <td>
	<select name="wl_akm_wpa3" onChange="wl_akm_wpa3_change();">
