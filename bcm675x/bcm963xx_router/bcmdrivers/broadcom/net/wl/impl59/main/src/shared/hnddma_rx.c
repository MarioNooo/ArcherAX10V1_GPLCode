 ...
 *
 * $Id: hnddma_rx.c 774125 2019-04-11 04:15:49Z $
 */
...
#if defined(BCMPCIEDEV) && (defined(STS_FIFO_RXEN) || defined(BME_OFFLOADS_RXSTS))
				if (BCMPCIEDEV_ENAB()) {
...
#endif /* BCMPCIEDEV && (STS_FIFO_RXEN || BME_OFFLOADS_RXSTS) */
				{
					free_p = head;
					if (prev != NULL) {
						head = PKTLINK(free_p);
