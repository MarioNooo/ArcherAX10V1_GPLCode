 ...
 *
 * $Id: wlioctl_defs.h 774215 2019-04-16 07:09:38Z $
 */
...
/*
    ...
    note: custom ioctl for get wds result;
    using 400 to avoid being covered when bcm adds new iotcl.
*/
...
/* Allow for build-specific preset value */
#if !defined(WL_BTC_WIRE)
#define WL_BTC_WIRE WL_BTC_DEFWIRE
#endif // endif
