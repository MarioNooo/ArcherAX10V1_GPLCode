 ...
 *
 * $Id: bcmsrom.c 773199 2019-03-14 14:36:42Z $
 */
...
/* for QT. NVRAM adopted from
 * http://wcc-svn.lvn.broadcom.net/viewvc/wlansvn?revision=781506&view=revision
 */
static char BCMATTACHDATA(defaultsromvars_6878)[] =
	"NVRAMRev=$Rev: 781506 $\0"
	"aa2g=0x3\0"
	"aa5g=0x3\0"
	"aga0=0x43\0"
	"aga1=0x43\0"
	"agbg0=0x83\0"
	"agbg1=0x83\0"
	"AvVmid_c0=4,120,4,75,4,75,4,75,4,75,4,75\0"
	"AvVmid_c1=4,115,4,70,4,70,4,70,4,70,4,70\0"
	"boardflags=0x0\0"
	...
	"maxp5gb4a0=88\0"
	"maxp5gb4a1=88\0"
	"mcs1024qam2gpo=0x9897\0"
	"mcs1024qam5ghpo=0xECECDBDC\0"
	"mcs1024qam5glpo=0xECECDBDB\0"
	"mcs1024qam5gmpo=0xECECDBDA\0"
	"mcs1024qam5gx1po=0xCBCBDACA\0"
	"mcs1024qam5gx2po=0xCBCBBACA\0"
	"mcs10poexp=0\0"
	"mcs11poexp=0\0"
	"mcs8poexp=0\0"
	"mcs9poexp=0\0"
	"mcsbw1605ghpo=0xb9777755\0"
	"mcsbw1605glpo=0xb9777755\0"
	"mcsbw1605gmpo=0xb9777755\0"
	"mcsbw1605gx1po=0xb9777755\0"
	"mcsbw1605gx2po=0xb9777755\0"
	"mcsbw202gpo=0x75431000\0"
	"mcsbw205ghpo=0x88653000\0"
	"mcsbw205glpo=0x88653000\0"
	"mcsbw205gmpo=0x88653000\0"
	"mcsbw205gx1po=0x88653000\0"
	"mcsbw205gx2po=0x88653000\0"
	"mcsbw402gpo=0x75432000\0"
	"mcsbw405ghpo=0xA8653200\0"
	"mcsbw405glpo=0xA8653200\0"
	"mcsbw405gmpo=0xA8653200\0"
	"mcsbw405gx1po=0x97642200\0"
	"mcsbw405gx2po=0x97643200\0"
	"mcsbw805ghpo=0xA8753220\0"
	"mcsbw805glpo=0xA8753200\0"
	"mcsbw805gmpo=0xA8753220\0"
	"mcsbw805gx1po=0x98643320\0"
	"mcsbw805gx2po=0x98753320\0"
	"mcslr5ghpo=0x0000\0"
	"mcslr5glpo=0x0000\0"
	"mcslr5gmpo=0x0000\0"
	...
	"noiselvl5ga1=31,31,31,31\0"
	"ofdmlrbw202gpo=0x0000\0"
	"pa2g40a0=0x1F9B,0xBCF9,0x7FFF,0x3549\0"
	"pa2g40a1=0x1E73,0xAFE6,0x2461,0x27AB\0"
	"pa2ga0=0x1F6E,0xA1F2,0x1950,0x2A51\0"
	"pa2ga1=0x1E3B,0xA190,0x0AEA,0x26FC\0"
	"pa2gccka0=0x2996,0xa5c7,0x0000,0x0000\0"
	"pa2gccka1=0x297e,0xa5de,0x0000,0x0000\0"
	"pa5g160a0=0x2568,0xcd91,0xf35b,0x0000,0x29db,0xb1a5,0x0000,0x1a52,0x277d,0xca12,0xf46f,"
	"0x0006,0x2b16,0xb438,0x0000,0x35c4,0x2ebb,0xb013,0xf8a2,0x0000\0"
	"pa5g160a1=0x2b66,0xaa4e,0x0000,0x00d7,0x2702,0xc709,0xf5a3,0x0000,0x2cdb,0xaa93,0x0000,"
	"0x0000,0x2abd,0xb74b,0xfdbc,0x1e35,0x2a96,0xb991,0xf839,0x0000\0"
	"pa5g40a0=0x1E33,0xE8C2,0xED5D,0x025E,0x4000,0x236E,0xD65A,0xF54B,0x1471,0x4000,0x20A9,"
	"0xE6B9,0xEFAD,0x1054,0x4000,0x20B0,0xE6A5,0xEF67,0x0F19,0x4000,0x20F3,0xE424,0xF15E,"
	"0x1287,0x4000\0"
	"pa5g40a1=0x2158,0xD70C,0xF530,0x0FAB,0x4000,0x2498,0xCF12,0xF8C4,0x1AC1,0x4000,0x2159,"
	"0xE11B,0xF21D,0x12FE,0x4000,0x2113,0xE65B,0xEFFC,0x13E7,0x4000,0x212F,0xE197,0xF255,"
	"0x131A,0x4000\0"
	"pa5g80a0=0x1DA9,0xDE03,0xF321,0x0001,0x4000,0x1F8F,0xD9EE,0xF63F,0x10A1,0x4000,0x2074,"
	"0xDE8D,0xF419,0x125E,0x4000,0x2029,0xE258,0xF28D,0x11FD,0x4000,0x2034,0xE2EA,0xF286,"
	"0x138F,0x4000\0"
	"pa5g80a1=0x231D,0xC9F4,0xFC7A,0x1DA1,0x4000,0x2297,0xCE8B,0xFAFC,0x1D82,0x4000,0x216F,"
	"0xD9AC,0xF644,0x1828,0x4000,0x20B8,0xDE54,0xF477,0x14D2,0x4000,0x20E3,0xDABC,0xF642,"
	"0x178F,0x4000\0"
	"pa5ga0=0x1FEF,0xD66A,0xF5E3,0x0000,0x4000,0x2091,0xD18E,0xF8CC,0x08CA,0x4000,0x222C,"
	"0xCE26,0xFB5A,0x153B,0x4000,0x229A,0xCC3E,0xFC27,0x163D,0x4000,0x2273,0xCC8B,0xFC88,"
	"0x1921,0x4000\0"
	"pa5ga1=0x2332,0xC528,0xFE76,0x1723,0x4000,0x2334,0xC4E4,0xFF5B,0x1B26,0x4000,0x217A,"
	"0xD3CD,0xF916,0x1418,0x4000,0x21E2,0xCF31,0xFBAB,0x1691,0x4000,0x221E,0xCDAB,0xFC6C,"
	"0x1881,0x4000\0"
	"papdcap2g=0\0"
	"papdcap5g=0\0"
	"paprdis=1\0"
	...
	"swctrlmap4_RXByp2g_fem7to4=11\0"
	"swctrlmap4_RXByp5g_fem3to0=0x44\0"
	"swctrlmap4_RXByp5g_fem7to4=22\0"
	...
	char **vars, uint *count)
{
	...
	*count = 0;
	...
	case SI_BUS:
		if (BCM6878_CHIP(sih->chip)) {
			/* Force to use static nvram for now */
		...
		if ((si_is_sprom_available(sih) && srom[0] == 0xffff) ||
			...
			if (defvarslen == 0) {
				...
				if (CHIPID(sih->chip) == BCM43570_CHIP_ID) {
					...
					defvarslen = srom_vars_len(defaultsromvars_6878);
					bcopy(defaultsromvars_6878, vp, defvarslen);
