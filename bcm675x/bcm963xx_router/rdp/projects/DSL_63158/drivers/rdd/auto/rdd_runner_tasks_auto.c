...
char *image_task_names[6][16] = {
	...
	{"US_TM_WAN_DIRECT", "US_TM_BUDGET_ALLOCATION", "US_TM_OVL_BUDGET_ALLOCATION", "US_TM_UPDATE_FIFO", "US_TM_FLUSH", "", "", "US_TM_WAN_AE2P5", "US_TM_WAN_AE10", "US_TM_WAN_DSL", "US_TM_WAN_PON", "", "", "", "US_TM_WAN_TX_DDR_READ", "US_TM_WAN_TX_PSRAM_WRITE"},
