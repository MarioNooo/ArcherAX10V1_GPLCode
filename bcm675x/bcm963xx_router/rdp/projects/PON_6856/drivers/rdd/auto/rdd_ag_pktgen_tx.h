...
int rdd_ag_pktgen_tx_pktgen_fpm_ug_mgmt_set(uint32_t budget, uint32_t fpm_ug_cnt, uint32_t fpm_ug_cnt_reg_addr, uint32_t fpm_ug_threshold);
int rdd_ag_pktgen_tx_pktgen_fpm_ug_mgmt_get(uint32_t *budget, uint32_t *fpm_ug_cnt, uint32_t *fpm_ug_cnt_reg_addr, uint32_t *fpm_ug_threshold);
