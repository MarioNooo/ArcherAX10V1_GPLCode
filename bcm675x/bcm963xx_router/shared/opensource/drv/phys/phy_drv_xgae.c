...
static void xgae_laser_output(phy_dev_t *phy_dev, laser_op_t on)
{
    int val;
...
void sf2_xgae_sfp_plug_cb(phy_dev_t *phy_dev, int plug)
{
    xgae_laser_output(phy_dev, plug? LASER_ON: LASER_FLOAT);
}
