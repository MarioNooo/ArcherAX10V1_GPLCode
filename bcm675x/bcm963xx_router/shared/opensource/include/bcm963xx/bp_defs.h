...
enum bp_id {
  ...
  bp_usGpioLedPower,    /* for both cfe and after cfe */
  bp_usGpioLedAnyLanLink, /* sdk has a bp_usGpioLedLan */
  bp_usGpioLedInternetOrg,
  bp_usGpioLedInternetBlue,
  bp_usGpioLedWps,
  bp_usGpioLedWL24G,    /* sdk has a bp_usGpioLedWL2_4GHz */
  bp_usGpioLedWL5G,     /* sdk has a bp_usGpioLedWL5GHz */
#endif  
  bp_last
};
