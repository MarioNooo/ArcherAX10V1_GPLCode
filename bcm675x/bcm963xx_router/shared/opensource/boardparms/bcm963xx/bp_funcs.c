...
static enum bp_id bpLedList[] = {
  ...
  bp_usGpioLedPower,
  bp_usGpioLedAnyLanLink,
  bp_usGpioLedInternetOrg,
  bp_usGpioLedInternetBlue,
  bp_usGpioLedWps,
  bp_usGpioLedWL24G,
  bp_usGpioLedWL5G,
#endif
...
#else
 MAP( bp_usGpioLedPower, power),
 MAP( bp_usGpioLedAnyLanLink, lan),
 { bp_usGpioLedInternetOrg, "internet:org"},
 { bp_usGpioLedInternetBlue, "internet:blue"},
 MAP( bp_usGpioLedWps, wps),
 { bp_usGpioLedWL24G, "wl2.4g"},  // . is a valid filename character, we can use it
 MAP( bp_usGpioLedWL5G, wl5g),
#endif
 {-1, NULL}
};
#endif
...
{
    return( BpGetGpio(bp_usGpioLedPower, pusValue ) );
} 

int BpGetWireless2GLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWL24G, pusValue ) );
} 

int BpGetWireless5GLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWL5G, pusValue ) );
}

int BpGetAnyLanLinkLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedAnyLanLink, pusValue ) );
} 

int BpGetWpsLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWps, pusValue ) );
}

int BpGetInterOrgLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedInternetOrg, pusValue ) );
} 

int BpGetInterBlueLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedInternetBlue, pusValue ) );
} 
